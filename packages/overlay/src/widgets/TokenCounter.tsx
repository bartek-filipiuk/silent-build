...
export const TokenCounter: React.FC<{ timeline: SessionTimeline; currentMs: number }> = ({ timeline, currentMs }) => {
  ...
  return (
    <div style={{ marginTop: 24 }}>
      ...
      <div style={{ width: '100%', height: 6, background: tokens.colors.grid, marginTop: 6 }}>
        <div style={{ width: `${pct}%`, height: '100%', background: tokens.colors.amber, transition: 'width 0.2s' }} />
      </div>
    </div>
  )
}

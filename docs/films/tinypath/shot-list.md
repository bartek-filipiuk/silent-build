...
> "I gave Claude Code 1 days · tinypath · SvelteKit. Here's what it built."

Suggested 3 takes with stress on different words.

### Shot #2 — Outro CTA (10 s, position 6:35–6:45)

> "https://github.com/bartek-filipiuk/silent-build is live now. GitHub link below. Next: silent build #N — <next>. Subscribe so you don't miss it."
...
1. Open `https://https://github.com/bartek-filipiuk/silent-build` in fresh browser window. (~3 s on landing)
